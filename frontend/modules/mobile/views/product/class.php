...
<body>
					...
					<section class="aui-grid-content">
						<div class="aui-grid-row aui-grid-row-clear">
							<a href="my-products-class.html" class="aui-grid-row-item">
								<i class="aui-icon-large aui-icon-sign"><img src="/assets/mobiles/mobile/img/ad/x-sf-1.jpg" alt=""></i>
								<p class="aui-grid-row-label">手机数码</p>
							</a>
							<a href="my-products-class.html" class="aui-grid-row-item">
								<i class="aui-icon-large aui-icon-sign"><img src="/assets/mobiles/mobile/img/ad/x-sf-2.jpg" alt=""></i>
								<p class="aui-grid-row-label">笔记本</p>
							</a>
							<a href="my-products-class.html" class="aui-grid-row-item">
								<i class="aui-icon-large aui-icon-sign"><img src="/assets/mobiles/mobile/img/ad/x-sf-3.jpg" alt=""></i>
								<p class="aui-grid-row-label">空调</p>
							</a>
							<a href="my-products-class.html" class="aui-grid-row-item">
								<i class="aui-icon-large aui-icon-sign"><img src="/assets/mobiles/mobile/img/ad/x-sf-4.jpg" alt=""></i>
								<p class="aui-grid-row-label">儿童文学</p>
							</a>
							<a href="my-products-class.html" class="aui-grid-row-item">
								<i class="aui-icon-large aui-icon-sign"><img src="/assets/mobiles/mobile/img/ad/x-sf-5.jpg" alt=""></i>
								<p class="aui-grid-row-label">啤酒</p>
							</a>
							<a href="my-products-class.html" class="aui-grid-row-item">
								<i class="aui-icon-large aui-icon-sign"><img src="/assets/mobiles/mobile/img/ad/x-sf-6.jpg" alt=""></i>
								<p class="aui-grid-row-label">海参</p>
							</a>
							<a href="#" class="aui-grid-row-item">
								<i class="aui-icon-large aui-icon-sign"><img src="/assets/mobiles/mobile/img/ad/x-sf-7.jpg" alt=""></i>
								<p class="aui-grid-row-label">床</p>
							</a>
							<a href="#" class="aui-grid-row-item">
								<i class="aui-icon-large aui-icon-sign"><img src="/assets/mobiles/mobile/img/ad/x-sf-8.jpg" alt=""></i>
								<p class="aui-grid-row-label">衣物清洁</p>
							</a>
							<a href="#" class="aui-grid-row-item">
								<i class="aui-icon-large aui-icon-sign"><img src="/assets/mobiles/mobile/img/ad/x-sf-9.jpg" alt=""></i>
	...
	<script src="/assets/mobiles/mobile/js/jquery.min.js"></script>
	<script src="/assets/mobiles/mobile/js/aui.js"></script>
</body>
</html>