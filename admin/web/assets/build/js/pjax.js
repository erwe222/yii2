    ...
    function(t) {
        ...
        function a(e, n, a) {
            ...
            if (! (e.which > 1 || e.metaKey || e.ctrlKey || e.shiftKey || e.altKey || location.protocol !== r.protocol || location.hostname !== r.hostname || r.href.indexOf("#") > -1 && m(r) == m(location) || e.isDefaultPrevented())) {
                ...
                t(r).trigger(c, [s]),
                c.isDefaultPrevented() || (o(s), e.preventDefault(), t(r).trigger("pjax:clicked", [s]))
            }
        }
        function r(e, n, a) {
            a = v(n, a);
            ...
            if ("GET" !== i.type && void 0 !== window.FormData) i.data = new FormData(r),
            i.processData = !1,
            i.contentType = !1;
            else {
        ...
        function o(e) {
            function n(e, n, r) {
                ...
                r.relatedTarget = a;
                var o = t.Event(e, r);
                return i.trigger(o, n),
                !o.isDefaultPrevented()
            }
            e = t.extend(!0, {},
            t.ajaxSettings, o.defaults, e),
            ...
            return u.readyState > 0 && (e.push && !e.replace && (b(o.state.id, f(i)), window.history.pushState(null, "", e.requestUrl)), n("pjax:start", [u, e]), n("pjax:send", [u, e])),
            o.xhr
        }
        function i(e, n) {
            var a = {
        ...
        function v(e, n) {
            ...
            n.container && (n.container = x(n.container)),
            n
        }
        function x(e) {
            if ((e = t(e)).length) {
        ...
        function y(e, n, a) {
            ...
            }), r.contents.find("title").remove(), r.scripts = g(r.contents, "script[src]").remove(), r.contents = r.contents.not(r.scripts)),
        ...
        function b(t, e) {
            ...
            X.push(t),
            E(U, 0),
            E(X, o.defaults.maxCacheLength)
        }
        function T(t, e, n) {
            var a, r;
            R[e] = n,
            "forward" === t ? (a = X, r = U) : (a = U, r = X),
            a.push(e),
            (e = r.pop()) && delete R[e],
            E(a, o.defaults.maxCacheLength)
        }
        function E(t, e) {
