        ...
        <div style="width:400px;min-height:100px;margin:0 auto;">
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                  <input type="text" id="route-box-name" name="route-box-name" value="<?php echo isset($role_info['name'])?$role_info['name']:'';?>"  autocomplete="off" placeholder="请填写角色名" class="layui-input menu-box-input" <?php if(!$is_add):?>readonly="readonly"<?php endif;?>>
              </div>
            </div>
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                  <input type="text" id="route-box-description" name="route-box-description" value="<?php echo isset($role_info['description'])?$role_info['description']:'';?>" autocomplete="off" placeholder="请填写角色描述" class="layui-input menu-box-input" >
              </div>
            ...
            layui.use(['layer', 'form'], function() {
                var layer = layui.layer,
                    ...
                    form.on('submit(add-route-from)', function(data) {
                        ...
                        if(name == ''){layer.close(loadIndex);layer.msg('角色名为必填项', {icon: 5});return false;}
                        if(description == ''){layer.close(loadIndex);layer.msg('角色描述为必填项', {icon: 5});return false;}
                        var parent_index = parent.layer.getFrameIndex(window.name);
                        $.ajax({
                            url:'/auth/change-role-info',
                            type:'post',
