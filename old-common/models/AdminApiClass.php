...
class AdminApiClass extends ApiClass{
    ...
    public function setAdminReg($params){
        if (!isset($params['username'])){
            return $this->returnData(301,[],$this->getParamErrTip('username'));
    ...
    public function insertManagerInfo($params){
        if (!isset($params['username'])){
            ...
            return $this->returnData(301,[],$this->getParamErrTip('status'));
        }
    ...
    public function insertRouteInfo($params){
        if (!isset($params['name'])){
            ...
            return $this->returnData(301,[],$this->getParamErrTip('description'));
        }
    ...
    public function deteleRouteInfo($params){
        if (!isset($params['routes'])){
            return $this->returnData(301,[],$this->getParamErrTip('routes'));
        }
    ...
    public function deleteMenuInfo($params){
        if (!isset($params['menus'])){
            return $this->returnData(301,[],$this->getParamErrTip('menus'));
        }
